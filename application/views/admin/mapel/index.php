                                ...
                                <div class="card-body table-responsive">
                                    <table class="table dt-responsive nowrap w-100" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $mapels['kelas'] ?></td>
                                                <td><?php echo $mapels['nama'] ?></td>
                                                <td>
                                                    <a href="<?php echo base_url("$web/edit/".$mapels['id']); ?>" class="btn btn-info btn-rounded waves-effect waves-light">
                                                        <span class="btn-label"><i class="fa fa-edit"></i></span> Edit
                                                    </a>
                                                    <a href="<?php echo base_url("$web/delete/".$mapels['id']); ?>" class="btn btn-danger btn-rounded waves-effect waves-light">
