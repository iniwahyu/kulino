                                ...
                                <form action="<?php echo base_url("$web/update/".$id); ?>" method="post">
                                    <div class="card-body table-responsive">                
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" name="username" required>
                                                    ...
                                                    <?php foreach($user as $users): ?>
                                                        <option value="<?php echo $users['id']; ?>" <?php echo $users['id'] == $pengguna['id_user'] ? 'selected' : ''; ?>><?php echo $users['username']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div> -->
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control" name="kode" value="<?php echo $pengguna['kode']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-3 col-form-label">Nama Lengkap *</label>
                                            <div class="col-9">
                                                <input type="text" class="form-control" name="nama" value="<?php echo $pengguna['nama']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" name="jenis_kelamin" required>
                                                    ...
                                                    <option value="Laki-Laki" <?php echo $pengguna['jenis_kelamin'] == 'Laki-Laki' ? 'selected' : ''; ?>>Laki-Laki</option>
                                                    <option value="Perempuan" <?php echo $pengguna['jenis_kelamin'] == 'Perempuan' ? 'selected' : ''; ?>>Perempuan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="number" class="form-control" name="nohp" value="<?php echo $pengguna['nohp']; ?>" required>
                                            </div>
                                        </div>
                                        <!-- Form -->
