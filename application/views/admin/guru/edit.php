...
<div class="row mb-3">
    <div class="col">
        ...
        <div class="card">
            ...
            <form action="<?php echo base_url("$web/update/".$guru['id']); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="card-body table-responsive">                
                        ...
                        <div class="col-9">
                            <select class="form-control" name="username" required>
                                ...
                                <?php foreach($user as $users): ?>
                                    <option value="<?php echo $users['id']; ?>" <?php echo $users['id'] == $guru['id_user'] ? 'selected' : ''; ?> ><?php echo $users['username']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" name="nuptk" value="<?php echo $guru['nuptk']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-3 col-form-label">Nama Lengkap *</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="nama" value="<?php echo $guru['nama']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-3 col-form-label">Email *</label>
                        <div class="col-9">
                            <input type="email" class="form-control" name="email" value="<?php echo $guru['email']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-3 col-form-label">No HP *</label>
                        <div class="col-9">
                            <input type="number" class="form-control" name="nohp" value="<?php echo $guru['nohp']; ?>" required>
                        </div>
                    </div>
                    <!-- Form -->
