                                    ...
                                    <form action="<?php echo base_url("$web/update/".$id); ?>" method="post">
                                        <div class="card-body table-responsive">                
                                                ...
                                                <div class="col-9">
                                                    <select class="form-control" id="mapel" name="mapel" data-toggle="select2" required>
                                                        ...
                                                        <?php foreach($mapel as $m): ?>
                                                            <option value="<?php echo $m['id'] ?>" <?php echo $m['id'] == $forum['id_mapel'] ? 'selected' : ''; ?>><?php echo "Kelas ".$m['kelas']." - ".$m['nama']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="<?php echo $forum['deskripsi']; ?>">
                                                </div>
                                            </div>
                                            <!-- Form -->
