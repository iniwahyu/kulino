                ...
                <table class="table dt-responsive nowrap w-100" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $gurus['nohp'] ?></td>
                            <td>
                                <a href="<?php echo base_url("$web/edit/".$gurus['id']); ?>" class="btn btn-info btn-rounded waves-effect waves-light">
                                    <span class="btn-label"><i class="fa fa-edit"></i></span> Edit
                                </a>
                                <a href="<?php echo base_url("$web/delete/".$gurus['id']); ?>" class="btn btn-danger btn-rounded waves-effect waves-light">
