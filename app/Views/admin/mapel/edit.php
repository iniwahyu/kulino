...
<div class="row mb-3">
    <div class="col">
        ...
        <div class="card">
            ...
            <form action="<?php echo base_url("$web/update/".$mapel['id']); ?>" method="post">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <select class="form-control" name="kelas" required>
                                ...
                                <option value="7" <?php echo $mapel['kelas'] == 7 ? 'selected' : ''; ?>>7</option>
                                <option value="8" <?php echo $mapel['kelas'] == 8 ? 'selected' : ''; ?>>8</option>
                                <option value="9" <?php echo $mapel['kelas'] == 9 ? 'selected' : ''; ?>>9</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" name="nama" value="<?php echo $mapel['nama']; ?>" required>
                        </div>
                    </div>
                    <!-- Form -->
